...
@section('content')
    ...
    <div class="container">
        ...
        <div align="right" style="margin-bottom:5px;">
            <button type="button" data-toggle="modal" data-target="#crudPractice2" class="btn btn-success btn-xs">Add</button>
        </div>
                ...
                @foreach ($user_table as $user)
                    <tr>
                        ...
                        <td>
                            ...
                            <img src="{{ asset('images/'. $user->image) }}" width="120px" height="60px"/>
                        </td>
                        <td>
    ...
    <div id="crudPractice2" class="modal fade" role="dialog">
